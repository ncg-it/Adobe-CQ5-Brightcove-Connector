...
<%
    ...
    pageContext.setAttribute("logo", "/etc/designs/cs/brightcove/shared/img/logo_brightcove.png");
        ...
        <div class="navbar-inner">
            <div class="container">
                ...
                <div class="pull-right">
                    <img src="${logo}" alt="Brightcove Console">
                </div>
    ...
    <div id="divConsole">
            ...
            <tr>
                ...
                <td width="75%" valign="top">
                    <table id="listTable" width="100%" cellspacing="0" callpadding="0">
                        ...
                        <tr class="trCenterHeader">
                            <td id="tdOne">
                                <div id="headTitle">All Videos</div>
                                ...
                                <div id="searchDiv_pl">
                                    ...
                                    <!--Store the search query in searchBut.value so we can use it as the title of the page once the results are returned.  See searchVideoCallBack -->
                                    <select id="selField_pl" name="selField_pl">
                            ...
                            <td id="tdTwo">
                                <div name="butDiv" class="butDiv">
                                    <span name="buttonRow"><!--The buttons in buttonRow are hidden in playlist view -->
                                        ...
                                        <button id="uplButton" class="uplButton" onClick="extFormUpload()">
                                            Upload Video
                                        </button>
                                        <button id="newplstButton" onClick="createPlaylistBox()">Create Playlist
                                        </button>
                                    </span>
                                    <button class="btn" name="delFromPlstButton" onClick="openBox('modPlstPop')">
                                ...
                                <table id="tblMainList" cellpadding="3" cellspacing="0">
                                    ...
                                    <tr id="trHeader">
                                        ...
                                        <th id="nameCol" class="tdMainTableHead sortable ASC" style="border-left:0px"
                                            data-sortType="ASC" data-sortBy="DISPLAY_NAME" onclick="sort(this)">
                                            Video Name
                                            <span class="order"></span>
                                        </th>
                                        <th id="lastUpdated" class="tdMainTableHead sortable NONE" data-sortType=""
                                            data-sortBy="MODIFIED_DATE" onclick="sort(this)">
                                            Last Updated
                                            <span class="order"></span>
                                        </th>
                            ...
                            <td>
                                <div name="butDiv" class="butDiv">
                                    <span name="buttonRow"><!--The buttons in buttonRow are hidden in playlist view -->
                                        ...
                                        <button id="newplstButton" onClick="createPlaylistBox()">
                                            Create Playlist
                                        </button>
                                    </span>
                                    <button class="btn" name="delFromPlstButton" onClick="openBox('modPlstPop')">
                ...
                <td id="tdMeta" valign="top" class="tdMetadata">
                    ...
                    <div id="divMeta.previewDiv">
                        <ul class="thumbnails">
                            <li class="span3">
                                <div class="thumbnail">
                                    ...
                                    <a onClick="changeVideoImage(document.getElementById('divMeta.id').innerHTML)"
                                       href="#" class="btn">Change Video Still Image
                                    </a>
                                </div>
                            </li>
                            <li class="span2">
                                <div class="thumbnail">
                                    ...
                                    <a onClick="changeImage(document.getElementById('divMeta.id').innerHTML)" href="#"
                                       class="btn">Change Thumbnail
                                    </a>
                                </div>
                            </li>
                        ...
                        <p>
                            <a href="#" onClick="doPreview(document.getElementById('divMeta.id').innerHTML)"
                               class="btn btn-primary">Video Preview
                            </a>
                        </p>
                    </div>
                    <br />Duration:
        ...
        <div id="uploadImageDiv" style="display:none" class="overlay tbInput">
            <form id="uploadImageForm" method="POST" enctype="multipart/form-data" target="postFrame">
                <br />
                <center>
                    <span class="title">Upload A New Image:</span>
                    <br />
                    <br />
                ...
                <center>
                    ...
                    <button type="button" id="cancelUploadButton" onClick="closeBox('uploadImageDiv',this.form)">
                        Cancel
                    </button>
                </center>
            </form>
        ...
        <div id="delConfPop" style="display:none" class="delConfPop overlay">
            <center>
                <strong style="font-size:14px;">DELETE</strong>
                <br />Are you sure you want to proceed?
                <br>
                <span class="subTitle">Delays up to 20 minutes may occur before changes are reflected</span>
                <br />
                <br />
        ...
        <div id="shareVideoDiv" style="display:none" class="overlay tbInput">
            <form id="shareVideoForm" method="POST" enctype="multipart/form-data" target="postFrame">
                <br />
                <center>
                    <span class="title">Share Video</span>
                    <br />
                    <br />
