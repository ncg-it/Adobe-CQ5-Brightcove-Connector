...
Brightcove.PlayerListCombo = CQ.Ext.extend(CQ.Ext.form.ComboBox, {
    ...
    constructor: function (config) {
        ...
        var storeConfig = CQ.Util.applyDefaults(config.storeConfig, {
            "proxy": new CQ.Ext.data.HttpProxy({
                "url": "/bin/brightcove/api.json?a=6",
                "method": "GET"
            }),
            "baseParams": {
                "_charset_": "utf-8"
        ...
        Brightcove.PlayerListCombo.superclass.constructor.call(this, config);
    },
...
CQ.Ext.reg("BrightcovePlayerListCombo", Brightcove.PlayerListCombo);