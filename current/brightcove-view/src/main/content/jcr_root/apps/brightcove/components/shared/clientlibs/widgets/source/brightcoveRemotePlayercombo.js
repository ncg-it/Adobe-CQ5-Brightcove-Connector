 ...
 */
Brightcove.RemotePlayerCombo = CQ.Ext.extend(CQ.Ext.form.ComboBox, {
     ...
     * <pre><code>
{
	...
	constructor : function(config) {
		...
		Brightcove.RemotePlayerCombo.superclass.constructor.call(this, config);
	},
...
CQ.Ext.reg ("BrightcoveRemotePlayerCombo", Brightcove.RemotePlayerCombo);